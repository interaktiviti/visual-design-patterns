...
namespace VisualDesignPatterns
{
	...
	/// </remarks>
	public partial class DesiHelpKeywordHelper : DesiHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DesiHelpKeywordHelper.
		/// </summary>
		protected DesiHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DesiHelpKeywordHelper.
		/// </summary>
		public static DesiHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DesiHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DesiHelpKeywordHelperBase.
		/// </summary>
		protected DesiHelpKeywordHelperBase()
			: base() { }
