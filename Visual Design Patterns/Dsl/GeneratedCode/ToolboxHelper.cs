...
namespace VisualDesignPatterns
{
	...
	/// </remarks>
	public partial class DesiToolboxHelper : DesiToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DesiToolboxHelper.
		/// </summary>
		public DesiToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DesiToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Desi toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "Desi.1.0";
		...
		/// <summary>
		/// Constructs a new DesiToolboxHelperBase.
		/// </summary>
		protected DesiToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::VisualDesignPatterns.DesiDomainModel.SingletonResourceManager.GetString("DesiToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::VisualDesignPatterns.DesiDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "VisualDesignPatterns.DesignPatternToolboxItem":
					// Add DesignPattern shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"VisualDesignPatterns.DesignPatternToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("DesignPatternToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("DesignPatternToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"VisualDesignPatterns.DesiToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DesiToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateExampleClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("DesignPatternToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::VisualDesignPatterns.DesignPattern.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "VisualDesignPatterns.AbstractClassToolboxItem":
					// Add AbstractClass shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"VisualDesignPatterns.AbstractClassToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("AbstractClassToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("AbstractClassToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"VisualDesignPatterns.DesiToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DesiToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"AbstractClass", // F1 help keyword for the toolbox item.
						resourceManager.GetString("AbstractClassToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::VisualDesignPatterns.AbstractClass.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::VisualDesignPatterns.DesiDomainModel));
