...
namespace VisualDesignPatterns
{
	...
	/// </summary>
	internal partial class DesiCommandSet : DesiCommandSetBase
	{
		/// <summary>
		/// Constructs a new DesiCommandSet.
		/// </summary>
		public DesiCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DesiCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DesiCommandSetBase.
		/// </summary>
		protected DesiCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDesiExplorerCommand,
				typeof(DesiEditorFactory).GUID);
		...
		{
			DesiExplorerToolWindow explorer = this.DesiExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DesiDocData CurrentDesiDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DesiDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DesiDocView CurrentDesiDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DesiDocView;
			}
		}
		...
		/// </summary>
		protected DesiExplorerToolWindow DesiExplorerToolWindow
		{
			get
			{
				DesiExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DesiExplorerToolWindow), true) as DesiExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DesiExplorerToolWindow explorerWindow = this.DesiExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DesiClipboardCommandSet : DesiClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DesiClipboardCommandSet.
		/// </summary>
		public DesiClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DesiClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DesiClipboardCommandSetBase.
		/// </summary>
		protected DesiClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
