...
namespace VisualDesignPatterns
{
	...
	/// </summary>
	internal partial class DesiDocView : DesiDocViewBase
	{
		/// <summary>
		/// Constructs a new DesiDocView.
		/// </summary>
		public DesiDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DesiDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DesiDocView.
		/// </summary>
		protected DesiDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DesiDocDataBase docData = this.DocData as DesiDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DesiDocViewBase should be an DesiDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::VisualDesignPatterns.DesiDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::VisualDesignPatterns.DesiDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::VisualDesignPatterns.DesiToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::VisualDesignPatterns.DesiToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DesiDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::VisualDesignPatterns.DesiHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::VisualDesignPatterns.DesiHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::VisualDesignPatterns.DesiHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
